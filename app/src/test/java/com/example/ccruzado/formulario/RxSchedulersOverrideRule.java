...
/*    private final RxAndroidSchedulersHook mRxAndroidSchedulersHook =


    private final Func1<Scheduler,Scheduler> mRxJavaInmediateScheduler =
    ...
    public Statement apply(Statement base, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                RxJavaHooks.reset();
                RxJavaHooks.setOnIOScheduler(mRxJavaInmediateScheduler);
                RxJavaHooks.setOnNewThreadScheduler(mRxJavaInmediateScheduler);
                base.evaluate();
